const CKB_REFERENCE_TEMPLATE = `# Config generated by \`ckb init --chain dev\`
...
const MINER_REFERENCE_TEMPLATE = `# Config generated by \`ckb init --chain dev\`
...
export function getEmbeddedReferenceTemplate(documentId: 'ckb' | 'miner'): string {
  return documentId === 'ckb' ? CKB_REFERENCE_TEMPLATE : MINER_REFERENCE_TEMPLATE;
}
